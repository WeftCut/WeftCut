...
const ALL_CHANNELS: readonly string[] = [
  ...
  'links_create', 'links_dissolve', 'links_rename', 'duplicate_layer', 'paste_layer', 'paste_layers', 'set_layers_enabled', 'delete_layer', 'delete_layers', 'ripple_delete_layers', 'remove_media', 'set_composition',
