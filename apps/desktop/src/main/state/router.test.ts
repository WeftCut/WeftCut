...
const ALL_CHANNELS: readonly string[] = [
  ...
  'move_effect', 'remove_effect', 'move_layer', 'restack_layer', 'trim_layer', 'split_layer_grouped',
  'groups_create', 'groups_dissolve', 'duplicate_layer', 'paste_layer', 'delete_layer', 'delete_layers', 'remove_media', 'set_composition',
