...
const enUS = {
  ...
  "tools": {
    ...
    "lock_history": "Lock undo",
    "unlock_history": "Unlock undo",
    ...
    "add_motif": "Add motif clip",
    "add_group_layer": "Add group clip",
    "duplicate_layer": "Duplicate clip",
    ...
    "links_create": "Link clips",
    "links_dissolve": "Unlink clips",
    "links_add_members": "Add clips to link",
    "links_remove_members": "Remove clips from link",
    "links_rename": "Rename link",
    "groups_create": "Group clips",
    "groups_add_members": "Add clips to group",
    "groups_ungroup": "Ungroup",
    "groups_rename": "Rename group",
    "move_layers_to_composition": "Move clips to timeline",
    "compositions_delete": "Delete timeline",
    "set_composition": "Update timeline settings",
    "fit_composition_to_layers": "Fit timeline duration to clips",
    ...
    "attach_marker": "Attach marker to clip",
    "detach_marker": "Detach marker",
    "set_keyframe": "Set keyframe",
    "remove_keyframe": "Remove keyframe",
    "clear_keyframes": "Clear keyframes",
    "retime_keyframe": "Move keyframe",
    "set_keyframe_easing": "Set keyframe easing",
    "set_keyframe_tangents": "Set keyframe tangents",
  ...
  settings: {
    ...
    content_state_queued: "Queued",
    content_state_resuming: "Resuming…",
    content_state_downloading: "Downloading…",
    content_state_verifying: "Verifying…",
    content_state_extracting: "Installing…",
    content_state_error: "Failed",
