...
const zhCN: Resources = {
  ...
  "tools": {
    ...
    "lock_history": "锁定撤销",
    "unlock_history": "解除撤销锁",
    "analyze_clip": "分析片段",
    "describe_clip": "描述片段内容",
    "transcribe_clip": "转录片段",
  ...
  settings: {
    ...
    content_retry: "重试下载",
    content_state_queued: "排队中",
    content_state_resuming: "正在续传…",
    content_state_downloading: "正在下载…",
    content_state_verifying: "正在校验…",
    content_state_extracting: "正在安装…",
    content_state_error: "失败",
    content_cancel: "取消",
