...
const zhCN: Resources = {
  ...
  "tools": {
    ...
    "add_motif": "添加 Motif 片段",
    "add_group_layer": "添加组片段",
    "duplicate_layer": "复制片段",
    "paste_layers": "批量复制片段",
    "update_layer": "修改片段",
    ...
    "links_create": "链接片段",
    "links_dissolve": "取消链接",
    "links_add_members": "把片段加入链接",
    "links_remove_members": "把片段移出链接",
    "links_rename": "重命名链接",
    "groups_create": "编组片段",
    "groups_add_members": "把片段加入组",
    "groups_ungroup": "解组",
    "groups_rename": "重命名组",
    "move_layers_to_composition": "移动片段到时间线",
    "compositions_delete": "删除时间线",
    "set_composition": "修改时间线设置",
    "fit_composition_to_layers": "让时间线时长贴合片段",
    "add_effect": "添加效果",
    "update_effect": "修改效果",
    "move_effect": "调整效果顺序",
    "remove_effect": "移除效果",
    ...
    "update_marker": "修改标记",
    "remove_marker": "移除标记",
    "attach_marker": "标记锚定到片段",
    "detach_marker": "解除标记锚定",
    "set_keyframe": "设置关键帧",
    "remove_keyframe": "删除关键帧",
    "clear_keyframes": "清除关键帧",
    "retime_keyframe": "移动关键帧",
    "set_keyframe_easing": "设置关键帧缓动",
    "set_keyframe_tangents": "设置关键帧切线",
