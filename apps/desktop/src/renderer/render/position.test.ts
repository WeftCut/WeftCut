...
beforeAll(initEval);
const path: MotionPath = { nodes: [{ id: 'a', point: { x: 0, y: 0 }, inHandle: { x: 0, y: 0 }, outHandle: { x: 0, y: 0 }, segment: 'Line' }, { id: 'b', point: { x: 10, y: 0 }, inHandle: { x: 0, y: 0 }, outHandle: { x: 0, y: 0 }, segment: 'Line' }, { id: 'c', point: { x: 10, y: 90 }, inHandle: { x: 0, y: 0 }, outHandle: { x: 0, y: 0 }, segment: 'Line' }] };
